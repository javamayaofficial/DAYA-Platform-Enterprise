...
$router->get('/', function (Request $request): Response {
    ...
    $content = $flashHtml
        ...
        . '<a href="/health" class="btn btn-dark">Cek Health</a>'
        . '<a href="/install" class="btn btn-outline-dark">Buka Installer</a>'
        . '<a href="/bootstrap/protected" class="btn btn-outline-secondary">Tes Protected Route</a>'
        . '</div>'
        ...
        . '<li class="list-group-item d-flex justify-content-between px-0"><span>Installed</span><strong>' . ($isInstalled ? 'Yes' : 'No') . '</strong></li>'
        . '<li class="list-group-item d-flex justify-content-between px-0"><span>DB Configured</span><strong>' . ($dbConfigured ? 'Yes' : 'No') . '</strong></li>'
        ...
        . '<li class="list-group-item d-flex justify-content-between px-0"><span>Mock User</span><strong>' . e((string) ($auth['user_id'] ?? '-')) . '</strong></li>'
